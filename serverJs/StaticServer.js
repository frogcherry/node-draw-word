...
staticServer.handle = function(urlObj){
	  ...
	  function loadResponseData(callback) {
	    ...
	    if(DEBUG) console.log("loading " + filename + "...");
	    readFile(filename, function (err, data) {
	      if (err) {
	    	  if(DEBUG) console.log("Error loading " + filename);
	        ...
	        if(DEBUG) console.log("static file " + filename + " loaded");
	        callback();
	      }
	    });
	  }
...
function returnError(errorCode, req, res){
	if(errorCode == "404"){
	  if(DEBUG) console.log("error code: 404");
